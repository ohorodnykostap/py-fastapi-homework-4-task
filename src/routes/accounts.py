...
from typing import cast, Annotated  # <- додано Annotated
...
async def register_user(
    ...
    # Відправка email асинхронно через BackgroundTasks
...
async def request_password_reset_token(
    ...
    reset_link = f"http://127.0.0.1/accounts/reset-password/complete/?token={reset_token.token}"
    background_tasks.add_task(
...
async def reset_password(
    ...
    try:
        ...
        # Email після успішного скидання пароля
        login_link = "http://127.0.0.1/accounts/login/"
        background_tasks.add_task(
